...
const he: CaseCopy = {
  kicker: 'קייס סטדי',
  title: 'עיצוב פלטפורמת רילוקיישן מאפס, תוך כדי רילוקיישן משלי',
  lead: 'Reloways התחיל כתגובה אישית למעבר מדינה שעשיתי בעצמי. עיצבתי ובניתי פלטפורמה שמאגדת במקום אחד ידע מעשי, נותני שירות מקומיים אמינים וקהילה, תוך כדי שאני חי את הבעיה שהיא פותרת.',
  meta: [
